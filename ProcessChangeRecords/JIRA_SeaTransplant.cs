...
public static class SeaTransplantInterface
{
   ...
   public static SeaTransplant_JIRA_Schema.RootObject ProcessSeaTransplant(LookupForm baseForm, string ExecutionURI, string JSONOutput)
   {
   ...
   private static SeaTransplant_JIRA_Schema.RootObject DeserializeJSONSeaTransplant(LookupForm baseForm, string sJSON)
   {
   ...
   public static SeaTransplant_JIRA_Schema.Issue DeserializeJSONSeaTransplantSingle(LookupForm baseForm, string sJSON)
   {
      try
      {
         baseForm.DebugOutputValue = "Deserializing JSON";
   ...
   private class SeaTransplantStuff
   {/*
      #region SeaTransplantSpecific
      private void ProcessSeaTransplant()
      {
         string JSONOutput = JSONResponse.Text.ToString();
      ...
      private void DisplaySeaTransplantRecord(SeaTransplant_JIRA_Schema.Issue result)
      {
         ...
         /*DeserializedOutput = "Key: " + result.key + Environment.NewLine +
